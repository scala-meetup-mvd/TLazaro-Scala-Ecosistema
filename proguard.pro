...
-keepdirectories
-dontoptimize
-optimizations !class/merging/*,field/propagation/*,!field/*,method/marking/final,!method/marking/*,!method/inlining/short,!method/inlining/unique
...
### Start Configuration for Libraries

# Libgdx
-keep class org.badlogic.** {
    <fields>;
    <methods>;
}

-keep class org.badlogic.gdx.** {
    <fields>;
    <methods>;
}
...
-keep class com.sun.opengl.** {
    <fields>;
    <methods>;
}

### End Configuration for Libraries
